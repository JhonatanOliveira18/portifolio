...
async function getAboutGithub() {
    try {
        const resposta = await fetch('https://api.github.com/users/JhonatanOliveira18');
            ...
            <article class="about-content">
                ...
                <div class="about-buttons-data">
                    <div class="buttons-container">
                        ...
                        <a href="https://docs.google.com/document/d/143d9dVlrXV1i-QA2JdODk6N-iuhtLNvA/edit?usp=sharing&ouid=115734884128123958142&rtpof=true&sd=true" target="_blank" class="botao-outline">Currículo</a>
                    </div>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/JhonatanOliveira18/repos?sort=updated&per_page=6');
